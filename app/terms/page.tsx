      ...
      <div className="container">
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            and facilitates sponsorships via PumpFun on the Solana blockchain. We provide
        ...
        <section className={styles.section}>
          <h2>4. Sponsorships &amp; Transactions</h2>
          <ul>
            <li>All sponsorships are voluntary and non-refundable.</li>
            <li>Transactions are processed on the Solana blockchain and are final.</li>
            <li>PumpBoard does not custody funds. Sponsorships go directly to developer wallets via PumpFun.</li>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>Attempt to manipulate the leaderboard or sponsorship metrics.</li>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            guarantee the accuracy of developer profiles, sponsorship amounts, or
